...
const AboutMe = () => {
  ...
  return (
    <div className="w-full">
      <div className="lg:flex flex-col  items-center lg:p-8 bg-white text-gray-800">
      <div className='lg:flex items-start justify-between w-full max-w-7xl'>
        <div className="w-auto h-auto lg:h-72 lg:w-96 bg-gray-300 rounded-xl flex items-center justify-center">
        ...
        <div className="lg:ml-8">
          ...
          <div className="grid grid-cols-1 text-start sm:grid-cols-2 md:grid-cols-4 lg:gap-4 mt-8">
            ...
            <div className="flex flex-col lg:ml-5 items-start">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mt-8 w-full max-w-4xl bg-gray-100 lg:p-4 rounded-lg">
